window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		function estimatePartialTokens(partial) {
		...
		*/
		function SessionProgressBar({ session, t, useProjection, useSessions }) {
			...
			const tokenRate = running && !pending && firstTokenAt !== null ? liveTokenRate(estimatePartialTokens(partial), firstTokenAt, rateNow) : null;
