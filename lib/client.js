window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		function stateLabel(snapshot, runningToolName, t) {
			if (snapshot.running) return runningToolName !== void 0 ? t("bar.tool", { name: runningToolName }) : t("bar.running");
			return t("bar.idle");
		}
		/**
		...
		*/
		function SessionProgressBar({ session, t }) {
				...
				children: /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
					...
					children: [
						...
						/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
							...
							children: stateLabel(session, toolName, t)
						}),
						/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
