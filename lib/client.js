window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		var SessionProgressBar_module_css_default = {
			...
			"dsh-session-progress-interrupted-glow": "oQ02Ea_dsh-session-progress-interrupted-glow",
			...
			"label": "oQ02Ea_label",
			"dsh-session-progress-warn-glow": "oQ02Ea_dsh-session-progress-warn-glow",
			"glyph": "oQ02Ea_glyph",
			"eta": "oQ02Ea_eta",
			"track": "oQ02Ea_track"
		};
		...
		*/
		function SessionProgressBar({ session, t, useProjection, useSessions }) {
			...
			const tokenRate = running && !pending && firstTokenAt !== null ? liveTokenRate(streamedTokenEstimate(partial, density), firstTokenAt, rateNow) : null;
