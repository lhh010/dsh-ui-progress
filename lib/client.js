		...
		function ProgressCard({ toolName, block, inspect, t, useSession }) {
			...
			if (args !== null) body = /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				...
				children: [
					...
					!failed && etaText !== null && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						className: ProgressCard_module_css_default.line,
						children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
							className: ProgressCard_module_css_default.lineLabel,
							children: t("card.eta")
		...
		function SessionProgressBar({ session, t, useProjection, useSessions }) {
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
				...
				children: /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
					...
					"data-state": pending ? "pending" : running ? "running" : completed ? "done" : "idle",
					children: [
						/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
						...
						/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
							...
							children: pending ? pendingLabel(ownPending, subPending, t) : stateLabel(session, toolName, thinking, counts, t)
						}),
						/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
