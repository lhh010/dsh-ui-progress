...
/**
* Host-side self-update endpoint for @dsh-external/dsh-ui-progress.
*
* GET  /dsh-ui-progress/latest  -> { latest: "vX.Y.Z" | null }  (git ls-remote)
* POST /dsh-ui-progress/update  { "tag": "vX.Y.Z" }             (pinned install)
...
*/
const UPDATE_PATH = "/dsh-ui-progress/update";
const LATEST_PATH = "/dsh-ui-progress/latest";
...
function isLinkInstall() {
	try {
		const p = resolve(dshHomePath("profiles", "web", "node_modules", "@dsh-external"), "dsh-ui-progress");
