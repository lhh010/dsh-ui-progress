...
> 1. Run `dsh plugin --profile web add '@dsh-external/dsh-ui-progress@github:omdsh-dev/dsh-ui-progress#v0.9.8'` (the first run may fail because pnpm 11 blocks node-pty build scripts)
...
> Pinned tag via git dependency (public mirror, recommended): `pnpm add '@dsh-external/dsh-ui-progress@github:omdsh-dev/dsh-ui-progress#v0.9.8'` (or `github:omdsh-dev/dsh-ui-progress`; historical: 0809 users `#v0.9.0`, 0808 users `#v0.8.0`, 0807 users `#v0.6.0`, 0805 users `#v0.1.0`).
