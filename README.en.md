...
> 1. Run `dsh plugin --profile web add '@dsh-external/dsh-ui-progress@github:lhh010/dsh-ui-progress#v0.9.11'` (the first run may fail because pnpm 11 blocks node-pty build scripts)
...
> Pinned tag via git dependency (public mirror, recommended): `pnpm add '@dsh-external/dsh-ui-progress@github:lhh010/dsh-ui-progress#v0.9.11'` (or `github:lhh010/dsh-ui-progress`; historical: 0809 users `#v0.9.0`, 0808 users `#v0.8.0`, 0807 users `#v0.6.0`, 0805 users `#v0.1.0`).
