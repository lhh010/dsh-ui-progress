...
| 插件版本 | DSH 快照 | 说明 |
| --- | --- | --- |
| `v0.10.1`（默认） | `dsh-v0.1.2-alpha.1`~`alpha.5`、`rc.1`、`0.1.3-alpha.1`~`0.1.6-alpha.1` | 声明支持 dsh-v0.1.6-alpha.1（npm 已发布，钉版本实机验证；client 插件面零代码差异，typecheck/45 单测全绿，热挂载实机验证） |
