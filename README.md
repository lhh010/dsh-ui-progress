...
| `v0.5.0`（默认） | `snapshots/20260806T160212Z-279244acb0`（snapshot0806） | 新构建：自带 `report_progress` 工具 + 系统提示词上报引导 |

> git 依赖方式固定 tag：`pnpm add '@dsh-external/dsh-ui-progress@github:dsh-external/dsh-ui-progress#v0.5.0'`（0805 用户用 `#v0.1.0`）。
